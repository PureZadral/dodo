        ...
        <div class="row">   <!-- header -->
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
                <?php
                    ...
                    $query2 = mysqli_query($connect, 'SELECT * FROM cart');
                ?>

                <?php while ($pc = $query2 -> fetch_assoc()) { ?>
                <div class="row">
                    
                    <div class="col-3">
                        <img src="<?php echo $pc["img"]; ?>" class="w-100">
                    </div>
                    <div class="col-4 mt-2">
                        <h5><?php echo $pc["name"];?></h5>                        
                    </div>
                    <div class="col-2 mt-2 px-0 text-center">
                        <h5><?php echo $pc["price"];?>  <span>₽</span></h5>                        
                    </div>
                ...
                <form action="clearall.php" method="GET">
                    <button class="btn btn-danger cls my-3">Очистить корзину</button>
                </form>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <form action="insert.php" method="GET">
                            ...
                            <input type="hidden" name="ingredients" value="<?php echo $pizza["ingredients"] ?>">
                            <input type="hidden" name="price" value="<?php echo $pizza["price"] ?>">
                            <input type="hidden" name="img" value="<?php echo $pizza["img"] ?>">
